  ...
  this.make = function (options, callback) {
    ...
    client[options.method](requestData, metadata, callOptions, function (err, resp) {
      if (err) {
        ...
        // setImmediate: evita stack overflow quando la callback gRPC è quasi-sincrona
        return setImmediate(function() { callback(err, resError); });
      }
      ...
      setImmediate(function() { callback(null, response); });
    });
  };
};